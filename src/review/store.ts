...
/**
 * Send one pasted or dropped image to the dev server and get back the path to
 * record on the note. Returns null when there is no dev server behind the app
 * — the console still works, it just cannot keep the picture.
 */
